...
var TextAreaLineNumbersWithCanvas = function () {
    ...
    var cssTd1 = 'border:1px #3453 solid; border-right:0px; vertical-align:top; width:1px; background: #efefef';
    var cssTd2 = 'border:1px #3453 solid; border-left:0px; vertical-align:top;';
    ...
    var cssCanvas = 'border:0px; background-color:#f1c1c20; margin-top:0px; padding-top:0px;';
    ...
    // TEXTAREA
    var ta = this.evalnode = document.getElementById('editor');
    ...
    ta.paintLineNumbers = function () {
        try {
            ...
            for (var i = startIndex; i < endIndex; i++) {
                ...
                if (linesTouched !== undefined && linesTouched[i+1] !== undefined) {
